...
using TempoVida.Models;
using TempoVida.Services;

namespace TempoVida.Controllers
{
    ...
    {        
        ...
        public HomeController(IOperationTransient operationTransient1, IOperationTransient operationTransient2, IOperationScoped operationScoped1, IOperationScoped operationScoped2, IOperationSingleton operationSingleton1, IOperationSingleton operationSingleton2)
        {
        ...
        public string Index()
        {
            return $"Transient1     : {_operationTransient1.OperationId} \n" +
